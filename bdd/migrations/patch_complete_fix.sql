-- ============================================
-- PATCH COMPLET: Correction de toutes les ambiguïtés
-- ============================================
-- Ce patch corrige TOUTES les références de colonnes
-- ============================================

-- 1. Supprimer TOUTES les fonctions et vues
...
-- 2. Recréer les tables de logs si nécessaires (sans erreur si elles existent)
...
-- 3. Fonction utilitaire : créer notification admin
...
-- 4. Vue des statistiques (sans ambiguïté)
...
-- 5. Fonction : bloquer utilisateurs expirés
...
-- 6. Fonction : obtenir abonnements qui expirent bientôt
...
-- 8. Fonction principale : vérification et blocage automatique
...
-- 9. Fonction : obtenir logs de blocage
...
-- 10. Fonction : obtenir notifications récentes
...
-- 11. Fonction : réactiver abonnement utilisateur
...
-- Confirmation
SELECT 
  '✅ Patch complet appliqué avec succès!' as message,
  '🔧 Toutes les ambiguïtés de colonnes corrigées' as details,
  NOW() as patched_at;